  ...
  return (
    <>
      <div className="flex-col hidden bg-gray-800 md:flex w-60">
        ...
        <div className="flex-1 overflow-y-scroll font-medium text-gray-300 pt-3 space-y-[21px] scrollbar-none hover:scrollbar-thin scrollbar-thumb-gray-950/[0.45]">
      ...
      <div className="flex flex-col flex-1 flex-shrink min-w-0 bg-gray-700">
        ...
        <div className="flex-1 overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-950/[0.45] scrollbar-track-gray-900/[0.5] scrollbar-thumb-rounded-2xl">
